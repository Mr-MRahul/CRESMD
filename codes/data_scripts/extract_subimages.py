...
def main():
    ...
    if mode == 'single':
        opt['input_folder'] = '../../datasets/val/input'
        opt['save_folder'] = '../../datasets/val/modified_input'
        opt['crop_sz'] = 480  # the size of each sub-image
        opt['step'] = 240  # step of the sliding crop window
        opt['thres_sz'] = 48  # size threshold
        extract_signle(opt)
    elif mode == 'pair':
        GT_folder = '../../datasets/DIV2K_train_HR'
        LR_folder = '../../datasets/DIV2K_train_LR_bicubic/X4'
        save_GT_folder = '../../datasets/DIV2K_sub'
        save_LR_folder = '../../datasets/DIV2K800_sub_bicLRx4'
        scale_ratio = 4
